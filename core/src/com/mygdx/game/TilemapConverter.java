...
public class TilemapConverter {
    public static Array<Fixture> importObjects(TiledMap tiledMap, World world, float scale) {
        ...
        for (MapObject object : objects) {
            ...
            if (object instanceof RectangleMapObject) {
                ...
                Gdx.app.error("TilemapConverter", "Can't convert object of " + object.getClass() + " type");
                continue;
            }
